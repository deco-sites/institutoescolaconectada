...
export interface Props {
  ...
  social?: Social[];
  titleWork?: string;
  contentWork?: HTMLWidget;
  selos?: Selos[];
  addressBottom?: string;
  rigthsReserved?: string;
  poweredBy?: HTMLWidget
}
...
export default function Footer({
  ...
  titleWork = "Trabalhe Conosco",
  contentWork = "Se você se identifica com a nossa missão, visão e valores, envie seu currículo para <a href='mailto:contato@escolaconectada.org'>contato@escolaconectada.org</a>",
  selos = [
    {
      image: "https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/1527/67120bcd-936a-4ea5-a760-02ed5c4a3d04",
      name: ""
    },
    {
      image: "https://ozksgdmyrqcxcwhnbepg.supabase.co/storage/v1/object/public/assets/1527/67120bcd-936a-4ea5-a760-02ed5c4a3d04",
  ...
  addressBottom = "Avenida Brigadeiro Faria Lima, 3144. Cj 131. Jardim Paulistano. São Paulo-SP. CEP: 01.451-000",
  rigthsReserved = "2024 - TODOS OS DIREITOS RESERVADOS INSTITUTO ESCOLA CONECTADA"
}: Props) {
  return (
